          ...
          <div className="links-div">
            <ul className="list">
              <li className="list-items">
                <NavLink className="shop-link" to="/products">
                  Shop
                </NavLink>
              </li>
              <li className="list-items">
                <NavLink to="/wishlist">
                  ...
                  <span
                    style={{
                      display: wishlistProducts.length !== 0 ? "flex" : "none",
                    }}
                  >
                    {" "}
              ...
              <li className="list-items">
                <NavLink to="/cart">
                  <i
                    class=" nav-icon fa fa-shopping-cart"
                    aria-hidden="true"
                  ></i>
                  <span
                    style={{
                      display: cartProducts.length !== 0 ? "flex" : "none",
                    }}
                  >
                    {" "}
